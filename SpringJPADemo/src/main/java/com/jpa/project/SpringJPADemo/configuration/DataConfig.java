package com.jpa.project.SpringJPADemo.configuration;
...
@EnableJpaRepositories("com.jpa.project.SpringJPADemo.repository")//repository
...
public class DataConfig {
	...
	LocalContainerEntityManagerFactoryBean entityManagerFactory() {
		...
		lfb.setPackagesToScan("com.jpa.project.SpringJPADemo.model");
